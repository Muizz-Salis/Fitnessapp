      ...
      >
        ...
        <div className="relative z-5 text-center px-6 max-w-2xl mx-auto">
          ...
          <p className="text-white mb-8">
            We're thrilled to have you join our community. Whether you're just
            starting your fitness journey or looking to take your training to
            the next level, you've come to the right place. Our goal is to help
            you achieve your personal best and enjoy a healthier lifestyle.
          </p>
        </div>
        ...
        <div className=" relative  mx-auto my-8 items-center justify-center flex p-8  bg-[#181717] before:absolute before:top-0 before:left-0 before:w-full before:h-[4px] before:bg-gradient-to-r before:from-black before:via-orange-500 before:to-black ">
          <div>
            <p className="text-white text-center mb-4">
              ...
              here to help. Let's make your fitness journey an enjoyable and
              rewarding experience! <br /> <br />
              Stay motivated and let's crush those goals together! <br /> <br />
              Warm regards, <br />
              The Yanyan Fitness Team
            </p>
            <button className="bg-orange-500 items-center flex my-4 text-black px-16 py-5 text-lg  mx-auto rounded-lg font-semibold hover:bg-orange-800 transition duration-300">
              Start your journey
            </button>
          </div>
        </div>

...
export default function Navbar2() {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-4.35-4.35m1.95-5.15a7.5 7.5 0 11-15 0 7.5 7.5 0 0115 0z" />
</svg>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14V10a6 6 0 10-12 0v4c0 .386-.149.75-.405 1.05L4 17h5m6 0a3 3 0 11-6 0" />
  </svg>
  ...
  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">
    ...
    <div className="relative">
            ...
            >
              <img
                src="/profile.jpg" // Change this to your profile image path
                alt="Profile"
           ...
           {/* <Menu as="div" className="relative inline-block">
            ...
            <Menu.Items className="absolute right-0 mt-2 w-48 bg-black rounded-md shadow-lg py-2 z-50">
              <Menu.Item>
                {({ active }) => (
                  <Link
                    href="/profile"
